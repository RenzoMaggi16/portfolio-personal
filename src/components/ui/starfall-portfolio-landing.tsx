...
const defaultData = {
  ...
  projects: [ 
    { title: 'FinTech Mobile App', description: 'React Native app with AI-powered financial insights.', tags: ['React Native', 'Node.js'], imageContent: <div className="text-2xl text-emerald-400/70">💰</div> }, 
    { title: 'Data Visualization Platform', description: 'Interactive dashboard for complex data analysis.', tags: ['D3.js', 'Python'], imageContent: <div className="text-2xl text-blue-400/70">📈</div> }, 
    { title: '3D Portfolio Site', description: 'Immersive WebGL experience with 3D elements.', tags: ['Three.js', 'WebGL'], imageContent: <div className="text-2xl text-purple-400/70">🎨</div> }, 
  ],
